...
\begin{frame}{2 jet + Missing ET selection}
  \begin{columns}
    \begin{column}{0.45\textwidth}\begin{figure}
      ...
      \includegraphics[scale=0.275]{img/Total_OS_EE_etmiss_2jet.pdf}
    \end{figure}\end{column}
    \begin{column}{0.45\textwidth}\begin{figure}
      \caption{$\mu^{+}\mu^{-}\slashed{E}_{T}$}
      \includegraphics[scale=0.275]{img/Total_OS_MM_etmiss_2jet.pdf}
    \end{figure}\end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Cut optimisation}
    \begin{figure}
      %\caption{Significance vs cut on $\chi^2$}
      \includegraphics[scale=0.275]{img/sigcomp.png}
    \end{figure}
\end{frame}
...
\begin{frame}{KDE parameterisation}
  \begin{columns}
    \begin{column}{0.45\textwidth}\begin{figure}
      ...
      \includegraphics[scale=0.275]{img/tagging.pdf}
    \end{figure}\end{column}
    \begin{column}{0.45\textwidth}\begin{figure}
      \caption{b-tag distributions}
      \includegraphics[scale=0.275]{img/logtagging.pdf}
    \end{figure}\end{column}
  \end{columns}
\end{frame}
